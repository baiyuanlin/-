					...
					<div className="room_main_warp">
						...
						<div className="room_main_right_warp">
							<div className="room_main_right">
								...
								<div className="room_main_right_rz">
									<p>入住时间</p>
									<div className="room_main_right_rzrq">
										<div className="right_rzrq_mx">
											<input  value="入住时间" className="rzrq_text"/>
											<span>至</span>
											< input value = "离店时间" className="rzrq_text1"/ >
										</div>
								
									</div>
									<div className="room_main_right_shuliang">
					...
					<div className="room_main_fydz list">
						...
						<div className="room_main_fydz_map">
							<Map center={{ lng: 121.487899486, lat: 31.24916171 }} zoom="12" style={{ "height": "400px" }}>
								...
								<NavigationControl />
								<InfoWindow position={{ lng: 121.487899486, lat: 31.24916171 }} text="上海" title="黄浦区-广东路339号" />
							</Map>
